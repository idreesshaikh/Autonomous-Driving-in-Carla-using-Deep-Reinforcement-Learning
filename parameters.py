...
MODEL_ONLINE = 'carla_dueling_dqn_online.pt'
MODEL_TARGET = 'carla_dueling_dqn_target.pt'

#SAC (hyper)parameters
SAC_LEARNING_RATE = 3e-4
SAC_CHECKPOINT_DIR = 'models/sac'
TAU = 0.005
ACTOR_SAC = 'carla_actor_sac.pt'
CRITIC_1_SAC = 'carla_critic_1_sac.pt'
CRITIC_2_SAC = 'carla_critic_2_sac.pt'
VALUE_SAC = 'carla_value_sac.pt'
TARGET_VALUE_SAC = 'carla_target_value_sac.pt'

#Proximal Policy Optimization (hyper)parameters
PPO_LEARNING_RATE = 2.5e-4  
PPO_CHECKPOINT_DIR = 'models/ppo'
POLICY_CLIP = 0.2
PPO_ACTOR = 'carla_actor_ppo.pt'
PPO_CRITIC = 'carla_critic_ppo.pt'
PPO_BATCH_SIZE = 5
