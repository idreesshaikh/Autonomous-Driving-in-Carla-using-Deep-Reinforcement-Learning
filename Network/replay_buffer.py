...
class ReplayBuffer(object):
    def __init__(self, max_size, img_shape, raw_features, n_actions):
    ...
    def save_transition(self, state, _state, action, reward, new_state, new_state_, done):
    ...
    def sample_buffer(self):
        ...
        return states, _states, actions, rewards, new_state, new_state_, dones
